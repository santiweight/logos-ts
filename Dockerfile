...
COPY hn-jobs/package.json hn-jobs/package-lock.json ./hn-jobs/
COPY hn-jobs/frontend/package.json hn-jobs/frontend/package-lock.json ./hn-jobs/frontend/

RUN npm ci --prefix logos-ts \
    && npm ci --prefix logos-ts/studio \
    && npm ci --prefix hn-jobs \
    && npm ci --prefix hn-jobs/frontend \
